...
const styles = [
    { id: 'modern', name: 'Modern', prompt: 'modern interior design', image: 'https://images.unsplash.com/photo-1567016432779-094069958ad5?q=80&w=800&auto=format&fit=crop' },
    ...
    { id: 'vintage', name: 'Vintage', prompt: 'vintage interior design', image: 'https://images.unsplash.com/photo-1513519247388-19345150d627?q=80&w=800&auto=format&fit=crop' },
    { id: 'baroque', name: 'Baroque', prompt: 'baroque luxury interior design', image: 'https://images.unsplash.com/photo-1616486341351-79b5b2446736?q=80&w=800&auto=format&fit=crop' },
    ...
    { id: 'scandinavian', name: 'Scandinavian', prompt: 'scandinavian interior design clean minimal', image: 'https://images.unsplash.com/photo-1583847268964-b28dc2f51ac9?q=80&w=800&auto=format&fit=crop' },
    { id: 'industrial', name: 'Industrial', prompt: 'industrial loft interior exposed brick metal', image: 'https://images.unsplash.com/photo-1505691938895-1758d7eaa511?q=80&w=800&auto=format&fit=crop' },
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-6xl mx-auto px-4">
                {styles.map((style) => {
                    ...
                    return (
                        ...
                        >
                            <div
                                className={`relative aspect-[4/5] w-full rounded-2xl overflow-hidden border-2 transition-all duration-500 ${
                                    isSelected
