                ...
                {palettes.map((palette) => {
                    ...
                    return (
                        <button
                            ...
                            className={`group flex flex-col items-center gap-2 sm:gap-4 p-3 sm:p-4 rounded-3xl border transition-all duration-300 ${isSelected
                        ...
                        >
                            ...
                            <span
                                className={`font-medium text-sm sm:text-base transition-colors text-center ${isSelected
                                        ? 'text-[#d4af37]'
